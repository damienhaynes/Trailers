...
namespace Trailers.Localisation
{
    static class Translation
    {
        ...
        public static string SettingOnlineVideosYouTubeMovieSearchStringName = "YouTube Movie Search String";
        public static string SettingOnlineVideosYouTubeMovieSearchStringDescription = "Specify the search string used for manual movie trailer searches on YouTube. Special replacement parameters for movies are %title% and %year%.";
        ...
        public static string SettingReShowMenuAfterTrailerName = "Reshow Menu After Trailer Playback";
        public static string SettingReShowMenuAfterTrailerDescription = "Enable this to reshow the menu after playback of a Trailer. If there is only a single local/online trailer available then this setting will be ignored.";
